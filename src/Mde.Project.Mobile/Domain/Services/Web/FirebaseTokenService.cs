...
public class FirebaseTokenService : IFirebaseTokenService{
    ...
    public FirebaseTokenService(IAppUserService appUserService)
    {
      ...
      public  async Task<ServiceResult<string>> RetrieveFromFireBaseAndStoreFcmTokenLocallyAsync()
{
    ...
    return ServiceResult<string>.Failure("FCM Token retrieval not supported on this platform.");
        ...
        public  async Task<ServiceResult<string>> UpdateFcmTokenOnServerAsync(IAppUserService appUserService)
        {
            try
            {
                ...
                var userIdResult = await _appUserService.GetCurrentUserIdAsync();
                ...
                var updateResult = await _appUserService.UpdateFcmTokenOnServerAsync(userIdResult.Data, localTokenResult.Data);
        ...
        public  async Task<ServiceResult<string>> GetStoredFcmTokenAsync()
        {
            try
            {
