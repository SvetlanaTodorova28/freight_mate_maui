...
public partial class AppUserRegisterPage : ContentPage{
    ...
    private void BackToLogin_OnTapped(object? sender, TappedEventArgs e){
        Navigation.PushAsync( new WelcomePage(_uiService, authenticationServiceMobile,_userRegisterViewModel, _loginViewModel));
    }
    ...
    private async void CreateAccount_OnClicked(object sender, EventArgs e){
        ...
        if (isRegistered){
            ...
            Application.Current.MainPage = new NavigationPage(new LoginPage(_loginViewModel,_uiService, authenticationServiceMobile,_userRegisterViewModel));
        }
